...
| 1.0.x   | RC     | Public Testing | not supported   |
| 1.1.x   | Stable | Production     | TBD             |
...
To report a vulnerability, please email **support@minkov.dev**. This email is exclusively for security-related
